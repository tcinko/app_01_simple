...
describe "User pages:" do
	...
	describe "index:" do
		...
		describe "pagination:" do
			...
			before(:all) { 90.times { FactoryGirl.create(:user) } }
...
# 		end
	end  # end `signup page` block


	describe "edit profile user:" do
		let(:user) { FactoryGirl.create(:user) }
...
# 			it { should have_link('Sign out', href: signout_path) }
	...
	end  # end `edit profile user` block
	...
	end  # end `following/followers` block
